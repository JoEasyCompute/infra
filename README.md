...
| `test/cpu-test.sh` | CPU socket or per-thread stress tester with crash-state checkpoints, `--status`, and optional temperature logging | [docs/cpu-test.md](/Users/josephcheung/Desktop/dev/infra/docs/cpu-test.md) |
