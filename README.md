...
- [install/user-bootstrap.sh](install/user-bootstrap.sh): creates or updates a user, installs a named repo SSH key from `keys/bootstrap/`, or accepts a file / pasted key, then grants passwordless sudo
...
- [docs/rebuild-gpu-livefs.md](docs/rebuild-gpu-livefs.md)
- [docs/build-gpu-liveiso.md](docs/build-gpu-liveiso.md)
- [docs/amd-base-install.md](docs/amd-base-install.md)
